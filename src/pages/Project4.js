  ...
  return (
    <div className="min-h-screen bg-[#FDFBF6] flex flex-col">
      ...
      <div className="relative h-80">
        <img
          src="images/Figure22.jfif"
          alt="Al-Wahat Smart Farms"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-30"></div>
        <div className="absolute bottom-0 left-0 p-8">
          <h1 className="text-4xl font-bold text-white">Al-Wahat Smart Farms</h1>
        </div>
      </div>
        ...
        <div className="w-full md:w-3/5 bg-white rounded-lg shadow-sm p-6 mb-8 md:mb-0">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Farm Name:Al-Wahat Smart Farms</li>
              <li>Situated in in the Al Wahat Al Bahariya Desert, Egypt</li>
              <li>The project focuses on transforming arid desert land into fertile agricultural fields using sustainable practices</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Utilizing solar-powered pivot irrigation to efficiently water crops in the desert environment.</li>
              <li>Implementing biodynamic methods to enhance soil fertility and promote ecological balance.</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Ecological Restoration: Reclaiming desert land and converting it into productive agricultural areas.</li>
              <li>Renewable Energy Usage: Harnessing solar energy to power farming operations, reducing reliance on non-renewable energy sources</li>
            </ul>
          </div>
          
          <a
           href="https://pivot.sekem.com/"
           target="_blank"
