  ...
  return (
    <div className="min-h-screen bg-[#FDFBF6] flex flex-col">
      ...
      <div className="relative h-80">
        <img
          src="images/Figure20.jfif"
          alt="Najd Agri-Tech Estate"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-30"></div>
        <div className="absolute bottom-0 left-0 p-8">
          <h1 className="text-4xl font-bold text-white">Nongshim Farm</h1>
        </div>
      </div>
        ...
        <div className="w-full md:w-3/5 bg-white rounded-lg shadow-sm p-6 mb-8 md:mb-0">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Farm Name:Nongshim Smart Farm </li>
              <li>Situated in Riyadh ,Saudi Arabia</li>
              <li>The farm aims to enhance local agricultural production using advanced hydroponic and vertical farming techniques</li>
              ...
              <li>This initiative is part of Saudi Arabia’s push towards food security and agricultural sustainability. </li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li> Automated climate control systems to optimize temperature, humidity, and light conditions​</li>
              <li>AI-driven monitoring for plant growth, water usage, and nutrient levels​</li>
              <li>Hydroponic farming (soilless cultivation) to reduce water consumption</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Efficient use of water-saving irrigation systems.​
              </li>
              <li> Reduction of carbon footprint through localized fresh produce production.​</li>
              <li> Minimal pesticide use, focusing on organic and controlled environments ​
              </li>
            </ul>
          </div>
          
          <a
           href="https://www.nongshimfarm.com"
           target="_blank"
