  ...
  return (
    <div className="min-h-screen bg-[#FDFBF6] flex flex-col">
      ...
      <div className="relative h-80">
        <img
          src="images/Figure21.jfif"
          alt="Red Sea Farms Greenhouse"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-30"></div>
        <div className="absolute bottom-0 left-0 p-8">
          <h1 className="text-4xl font-bold text-white">Red Sea Farms</h1>
        </div>
      </div>
        ...
        <div className="w-full md:w-3/5 bg-white rounded-lg shadow-sm p-6 mb-8 md:mb-0">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Located in Thuwal, KAUST</li>
              <li>Specializes in large-scale greenhouse farming, utilizing modern techniques and ensuring environmentally responsible agricultural practices</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>AI-powered climate control to monitor and adjust greenhouse conditions for optimal plant growth</li>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Biological pest control: Uses natural predators instead of chemical pesticides to maintain ecological balance</li>
              <li>Organic soil & natural fertilizers: Enhances soil health and promotes sustainable farming</li>
              <li>Solar-powered greenhouses: Reduces reliance on fossil fuels, making farming more energy-efficient</li>
            </ul>
          </div>
          <a
           href="https://innovation.kaust.edu.sa/tag/red-sea-farms/"
           target="_blank"
