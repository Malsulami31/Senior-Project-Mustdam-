  ...
  return (
    <div className="min-h-screen bg-[#FDFBF6] flex flex-col">
      ...
      <div className="relative h-80">
        <img
          src="images/Figure19.jfif"
          alt="Najd Agri-Tech Estate"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-30"></div>
        <div className="absolute bottom-0 left-0 p-8">
          <h1 className="text-4xl font-bold text-white">IFarm Vertical Farm</h1>
        </div>
      </div>
        ...
        <div className="w-full md:w-3/5 bg-white rounded-lg shadow-sm p-6 mb-8 md:mb-0">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Farm Name:IFarm Vertical Farm</li>
              <li>Situated in Riyadh ,Saudi Arabia</li>
              <li>Approximately 2,569 square meters</li>
              <li>iFarm’s team of world-class specialists in IT, agriculture and hardware automation provide cost-effective vertical farming technologies to enable sustainable and responsible indoor farming around the world.</li>
              <li>believe sustainable indoor farming technologies will improve the lives of every human being on earth. </li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li> The company employs advanced climate control systems to optimize growing conditions within their greenhouses, enhancing crop yields and resource efficiency.​</li>
              <li>Maintains optimal growing conditions by regulating temperature, humidity, and light.​</li>
              <li>Employs Nutrient Film Technique (NFT) for efficient water and nutrient delivery.</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Hydroponic systems reduce water consumption compared to traditional farming methods.​
              </li>
              <li> Controlled environments minimize the need for chemical pesticides.​</li>
              <li> Growing produce near consumers reduces transportation emissions and ensures fresher products. ​
              </li>
            </ul>
          </div>
          
          <a
           href="https://www.agritecture.com/blog/2021/9/29/12-top-saudi-arabian-agriculture-companies-and-startups"
           target="_blank"
