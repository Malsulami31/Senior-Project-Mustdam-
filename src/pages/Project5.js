  ...
  return (
    <div className="min-h-screen bg-[#FDFBF6] flex flex-col">
      ...
      <div className="relative h-80">
        <img
          src="images/Figure23.jfif"
          alt="Saudi Greenhouses Management & Agri Marketing Co. "
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-30"></div>
        <div className="absolute bottom-0 left-0 p-8">
          <h1 className="text-4xl font-bold text-white">Saudi Greenhouses Management & Agri Marketing Co. </h1>
        </div>
      </div>
        ...
        <div className="w-full md:w-3/5 bg-white rounded-lg shadow-sm p-6 mb-8 md:mb-0">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Farm Name:Saudi Greenhouses Management & Agri Marketing Co</li>
              <li>Located Saudi Arabia (multiple locations)</li>
              <li>The project focuses on large-scale greenhouse farming</li>
              <li> dedicated to food safety and employs biocontrol programs to ensure environmentally responsible agricultural practices</li>
            </ul>
          </div>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Utilizing AI-powered climate control.</li>
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-5 space-y-1 text-gray-700">
              <li>Use of biological pest control (natural predators instead of chemical pesticides).</li>
              <li>Use of organic compost and natural fertilizers to improve soil health.</li>
              <li>Implementation of solar-powered greenhouses to reduce dependence on fossil fuels.</li>
            </ul>
          </div>
